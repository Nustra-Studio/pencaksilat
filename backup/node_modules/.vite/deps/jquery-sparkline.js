...
(function(document2, Math2, undefined) {
  (function(factory) {
    ...
    $.fn.simpledraw = function(width, height, useExisting, interact) {
      ...
      if ($.fn.sparkline.canvas === false) {
        ...
        if (!!(el.getContext && el.getContext("2d"))) {
          $.fn.sparkline.canvas = function(width2, height2, target2, interact2) {
    ...
    MouseHandler = createClass({
      ...
      mouseenter: function(e) {
        $(document2.body).unbind("mousemove.jqs");
        $(document2.body).bind("mousemove.jqs", $.proxy(this.mousemove, this));
        this.over = true;
    ...
    $.fn.sparkline.box = box = createClass($.fn.sparkline._base, {
      ...
      render: function() {
        var target = this.target, values = this.values, vlen = values.length, options = this.options, canvasWidth = this.canvasWidth, canvasHeight = this.canvasHeight, minValue = options.get("chartRangeMin") === undefined ? Math2.min.apply(Math2, values) : options.get("chartRangeMin"), maxValue = options.get("chartRangeMax") === undefined ? Math2.max.apply(Math2, values) : options.get("chartRangeMax"), canvasLeft = 0, lwhisker, loutlier, iqr, q1, q2, q3, rwhisker, routlier, i, size, unitSize;
...
//# sourceMappingURL=jquery-sparkline.js.map
