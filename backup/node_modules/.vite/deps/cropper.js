...
if (import_jquery.default.fn) {
  AnotherCropper$1 = import_jquery.default.fn.cropper;
  NAMESPACE$1 = "cropper";
  import_jquery.default.fn.cropper = function jQueryCropper(option) {
    for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      args[_key - 1] = arguments[_key];
    }
    var result;
    this.each(function(i, element) {
      ...
      if (!cropper) {
        ...
        var options = import_jquery.default.extend({}, $element.data(), import_jquery.default.isPlainObject(option) && option);
        cropper = new Cropper(element, options);
        $element.data(NAMESPACE$1, cropper);
      }
      if (typeof option === "string") {
        var fn = cropper[option];
        if (import_jquery.default.isFunction(fn)) {
  ...
  import_jquery.default.fn.cropper.Constructor = Cropper;
  import_jquery.default.fn.cropper.setDefaults = Cropper.setDefaults;
  import_jquery.default.fn.cropper.noConflict = function noConflict() {
    import_jquery.default.fn.cropper = AnotherCropper$1;
    return this;
  };
}
var AnotherCropper$1;
var NAMESPACE$1;
/*! Bundled license information:

cropper/dist/cropper.esm.js:
  (*!
   * Cropper v4.1.0
