import {
  require_jquery
} from "./chunk-GK6TSXOE.js";
import {
  __commonJS
} from "./chunk-AUZ3RYOM.js";

// node_modules/ion-rangeslider/js/ion.rangeSlider.js
var require_ion_rangeSlider = __commonJS({
  "node_modules/ion-rangeslider/js/ion.rangeSlider.js"(exports) {
    (function(factory) {
      if ((typeof jQuery === "undefined" || !jQuery) && typeof define === "function" && define.amd) {
        ...
        factory(require_jquery(), document, window, navigator);
      } else {
        factory(jQuery, document, window, navigator);
      }
    })(function($, document2, window2, navigator2, undefined) {
      "use strict";
      var plugin_count = 0;
      ...
      IonRangeSlider.prototype = {
        ...
        pointerFocus: function(e) {
          if (!this.target) {
            ...
            x += $handle.width() / 2 - 1;
            this.pointerClick("single", { preventDefault: function() {
            }, pageX: x });
          }
        },
        /**
        ...
        calc: function(update) {
          ...
          switch (this.target) {
            ...
            case "both_one":
              ...
              var real_x = this.convertToRealPercent(handle_x), from = this.result.from_percent, to = this.result.to_percent, full = to - from, half = full / 2, new_from = real_x - half, new_to = real_x + half;
              if (new_from < 0) {
                new_from = 0;
        ...
        drawLabels: function() {
          ...
          if (this.options.type === "single") {
            ...
            this.calcLabels();
            var min = Math.min(this.labels.p_single_left, this.labels.p_from_left), single_left = this.labels.p_single_left + this.labels.p_single_fake, to_left = this.labels.p_to_left + this.labels.p_to_fake, max = Math.max(single_left, to_left);
...
export default require_ion_rangeSlider();
