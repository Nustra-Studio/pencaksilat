    ...
    (function(factory) {
      if (typeof define === "function" && define.amd) {
        ...
        module.exports = function(root, $2) {
          ...
          if (!$2 || !$2.fn.dataTable) {
            $2 = (init_jquery_dataTables(), __toCommonJS(jquery_dataTables_exports))(root, $2).$;
          }
      ...
      "use strict";
      var DataTable2 = $2.fn.dataTable;
      $2.extend(true, DataTable2.defaults, {
...
export default require_dataTables_bootstrap5();
